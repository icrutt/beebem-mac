...
//		{
//			trace_186 = 1;
//			MemoryDump(0x5a000, 0x10010);
//			MemoryDump(0x6a870, 0x10010);
//		}

//      if (trace_186) if (( (I.pc & 0xffff) < 0x18e9) || ( (I.pc & 0xffff) > 0x1907) )
//      {
//			Dis186();
//		}
        
//       if (I.pc == (0xc612 * 16 + 0x21a4))		// Int 0x10 - Video Bios
//       {
//			Dis186();
//	   }
...
//        {
//            MemoryDump(((dma_src_segment & 0x0f) << 16) + dma_src_offset, 0x10000);
//        }
